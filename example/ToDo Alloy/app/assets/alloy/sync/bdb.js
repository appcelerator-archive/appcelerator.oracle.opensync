...
function installDatabase(config) {
    ...
    var db = _database.install(dbFile, dbName), rs = db.execute("pragma table_info(\"" + table + "\");"), columns = {};
    while (rs.isValidRow()) {
...
module.exports.beforeModelCreate = function(config, name) {
    ...
    if (typeof _database == "undefined") throw "No support for Titanium.Database in MobileWeb environment.";
